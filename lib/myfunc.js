...
let proto, getContentType;

// Initialize baileys module asynchronously
(async () => {
  try {
    const baileys = await import('@whiskeysockets/baileys');
    proto = baileys.proto;
    getContentType = baileys.getContentType;
    console.log('✅ Baileys module initialized');
  } catch (err) {
...
// Export proto and getContentType for use in other modules
exports.getProto = () => proto
